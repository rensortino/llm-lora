...
adapter_id = "output/lora-bloom-finance"
...
lora_model = PeftModel.from_pretrained(model, adapter_id, adapter_name="finance")
...
gr.Interface(
    ...
    title="🦙💰💸 Finance Alpaca-LoRA",
    description="Wealth Alpaca-LoRA is a 7B-parameter LLaMA model finetuned to follow instructions focused on wealth/finance. It is trained on the [Stanford Alpaca](https://github.com/tatsu-lab/stanford_alpaca) dataset customized with FinQA and other data - more info here: https://huggingface.co/datasets/gbharti/finance-alpaca - and makes use of the Huggingface LLaMA implementation. For more information on Alpaca, please visit [Alpaca-LoRa](https://github.com/tloen/alpaca-lora) and for more info on this implementation, please visit [Wealth Alapca-LoRa](https://github.com/gaurangbharti1/wealth-alpaca)",  # noqa: E501
).queue().launch()